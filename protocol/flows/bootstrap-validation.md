...
Define the complete validation rules for Project Bootstrap. This registered component is jointly owned by the Bootstrap Flow and does not define another Flow.
